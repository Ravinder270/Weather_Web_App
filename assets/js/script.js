...
function renderLastSearch() {
    ...
    if (storedCities.length === 0) {
        var initialURL = "https://api.openweathermap.org/data/2.5/weather?q=Delhi&units=metric&appid=7e95c9ef74c38248694c1e89b6931639";
    } else {
        var initialURL = "https://api.openweathermap.org/data/2.5/weather?q=" + lastSearch + "&units=metric&appid=7e95c9ef74c38248694c1e89b6931639";
    }
